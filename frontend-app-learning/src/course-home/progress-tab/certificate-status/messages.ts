...
const messages = defineMessages({
  ...
  saveToIcgButton: {
    id: 'progress.certificateStatus.saveToIcgButton',
    defaultMessage: 'Save to ICG Portal',
    description: 'Button text to save certificate to ICG portal',
  },
  saveToIcgSuccess: {
    id: 'progress.certificateStatus.saveToIcgSuccess',
    defaultMessage: 'Certificate saved to ICG Portal successfully!',
    description: 'Success message when certificate is saved to ICG portal',
  },
  saveToIcgError: {
    id: 'progress.certificateStatus.saveToIcgError',
    defaultMessage: 'Failed to save certificate to ICG Portal. Please try again.',
    description: 'Error message when saving certificate to ICG portal fails',
  },
  saveToIcgAlreadyAdded: {
    id: 'progress.certificateStatus.saveToIcgAlreadyAdded',
    defaultMessage: 'Certificate already added to ICG Portal.',
    description: 'Message when certificate is already in ICG portal',
  },
  savingToIcg: {
    id: 'progress.certificateStatus.savingToIcg',
    defaultMessage: 'Saving to ICG Portal...',
    description: 'Loading message when saving certificate to ICG portal',
  },
  notAvailableHeader: {
